...
<img src="system architecture diagram.png" alt="Sistem Mimarisi" width="800">
...
Konteynerler ayağa kalktıktan sonra, projenin özel güvenlik kurallarının (Active-Response ve SOC yapılandırmaları) konteynerlerin içine otomatik olarak aktarılması için terminalde aşağıdaki PowerShell komutunu çalıştırın:

```powershell
.\apply_custom_configs.ps1
```
...
- **Wazuh Arayüzü (UI)**: Tarayıcınızdan [https://localhost:443](https://localhost:443) adresine giderek erişebilirsiniz. (Varsayılan Kullanıcı: `admin`, Şifre: `SecretPassword`)
